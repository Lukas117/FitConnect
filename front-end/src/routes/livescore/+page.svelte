...
<body>
	...
	<div class="grid grid-flow-col gap-5 text-center auto-cols-max justify-center">
		<div
			class="flex flex-col p-2 bg-neutral rounded-box text-neutral-content items-center"
		>
	...
	<div class="flex">
		<div
			class="flex-grow h-32 bg-white rounded-box flex items-center justify-center relative"
		>
			<div class="card">TEAM 1</div>
		</div>
		<div
			class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-0.5 h-[50vh] bg-gray-600"
		/>
		<div class="border-r mx-2" />

		<div
			class="flex-grow h-32 bg-base-300 rounded-box flex items-center justify-center relative"
		>
	...
	<div class="flex">
		...
		>
			<div
				class="w-40 h-40 bg-primary rounded-full flex items-center justify-center text-white cursor-pointer mx-auto"
			>
