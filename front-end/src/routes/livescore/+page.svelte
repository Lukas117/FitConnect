...
<div class="flex pt-14 pb-24 items-center justify-center">
    ...
    <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-0.5 h-[30vh] bg-black"
...
<div class="flex flex-col items-center justify-center text-center mt-4">
    ...
    {/if}
    <iframe class="mx-auto mt-4" id="iframeScore" src="http://192.168.199.214:3000" title="hardware" width="0%"
