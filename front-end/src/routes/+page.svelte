...
<section>
    <button on:click={goToFaq}
            class="mt-24 ml-72 bg-orange-300 text-white
...
<section class="max-w-2xl p-5 text-center">
    <p class="text-2xl">
        Discover the incredible features of our
        platform such as locating sport events in your area.
        The more you engage, the more enjoyable your
        experience will be.
    </p>
</section>
...
<div class="mt-auto mb-10">
    <section>
        <button on:click={goToLogin}
                ...
                px-16 py-3 text-2xl rounded-md">
            Log In
        </button>
    </section>

    <section class="mt-4">
        <button on:click={goToRegister}
                class="bg-red-700 text-white
                px-14 py-3 text-2xl rounded-md">
            Sign up
        </button>
    </section>
</div>
