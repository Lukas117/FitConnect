		...
		<div class="space-y-5">
			<div class="bg-slate-100 p-4 shadow-md rounded-md">
				...
				<div id="answer1" class="mt-2" style="display: none">
					First you have to register in 
					the app. You will see the landing page,
