            ...
            <div class="bg-box">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex items-center">
                        <p class="text-white bg-titles rounded-md" style="width: 200px;">#1 Hoop Sensor not Setup</p>
                        <button class="bg-button text-text px-2 py-1 rounded ml-4 focus:outline-none">Add</button>
                    </div>
                    <div class="flex items-center">
                        <p class="text-white  bg-titles rounded-md" style="width: 200px;">#2 Hoop Sensor not Setup</p>
                        <button class="bg-button text-text px-2 py-1 rounded ml-4 focus:outline-none">Add</button>
                    </div>
                </div>
            </div>
