<script>
  ...
  // TODO: cannot join if event is full
...
{#if $showJoinModal}
    ...
    >
        ...
        <div
                class="bg-background relative p-8 rounded-md shadow-md w-5/6 mb-12"
        >
            ...
            <form class="space-y-4">
                ...
                <div class="flex">
                    ...
                    <h2 class="text-2xl font-bold mb-4 bg-gray-300 rounded-lg p-2 mb-6 ml-2">
                        FACILITY1
                    </h2>
                </div>
                <div class="flex">
