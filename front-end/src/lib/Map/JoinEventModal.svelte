...
{#if $showJoinModal}
	...
	>
		...
		<div
			class="bg-background 
			bg-opacity-90 relative p-8 rounded-md shadow-md w-5/6 mb-12"
		>
			...
			<form class="space-y-4">
				...
				<div class="flex">
					...
					<h2
						...
						mb-4 bg-gray-300 rounded-lg p-2 mb-6 ml-2"
					>
						FACILITY1
					</h2>
				</div>
				...
				<div class="flex justify-between items-center mb-4">
					...
					<button
						...
						class="bg-button text-text 
						px-4 py-2 rounded hover:bg-blue-600 focus:outline-none"
					>
						Join
					</button>
				</div>
