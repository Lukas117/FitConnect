...
//           const user_name = 'nonexistent';
//           const result = await matchTwoFieldsAsync(email, user_name);
//           expect(result.data.length).toBe(0); 
   
//         });

//         it('should throw an error if an error occurs during matching', async () => {
//             const email = 'johndoe@example.com';
//             const user_name = 'johndoe';
//             await expect(matchTwoFieldsAsync(email, user_name)).rejects.toThrow();
//         });
//     });

//     describe('getUserFromTwoFieldsMatchAsync', () => {
//         it('should retrieve a user if a match is found', async () => {
//             const fieldName = 'email';
//             const valueMatch = 'johndoe@example.com';
//             const secondFieldName = 'user_name';
//             const secondValueMatch = 'johndoe';
//             const user = await getUserFromTwoFieldsMatchAsync(fieldName, valueMatch, secondFieldName, secondValueMatch);
//             expect(user).toBeDefined();
//             expect(user.email).toBe(valueMatch);
//             expect(user.user_name).toBe(secondValueMatch);
//         });
...
//             const valueMatch = 'nonexistent@example.com';
//             const secondFieldName = 'user_name';
//             const secondValueMatch = 'nonexistent';
//             const user = await getUserFromTwoFieldsMatchAsync(fieldName, valueMatch, secondFieldName, secondValueMatch);
//             expect(user).toBeNull();
//         });
...
//             const secondFieldName = 'invalidField2';
//             const secondValueMatch = 'value2';
//             await expect(getUserFromTwoFieldsMatchAsync(fieldName, valueMatch, secondFieldName, secondValueMatch)).rejects.toThrow();
//         });
//     });
// });
